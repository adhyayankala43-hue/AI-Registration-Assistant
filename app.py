...
ADMIN_STATIC_PASSWORD = os.getenv("ADMIN_PASSWORD")
...
<body class="bg-slate-100 min-h-screen flex items-center justify-center p-4 flex-col">
...
<!-- ======== NEW PARTNERS / CREDITS FOOTER ======== -->
<div class="mt-8 text-center text-xs text-slate-500 pb-6 w-full max-w-[1300px] mx-auto">
    <p class="font-semibold mb-3 text-slate-600 uppercase tracking-wider">Technology Partners & Supported Integrations</p>
    <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 font-medium">
        <a href="https://fastapi.tiangolo.com/" target="_blank" class="hover:text-indigo-600 transition">FastAPI</a>
        <a href="https://www.mongodb.com/" target="_blank" class="hover:text-indigo-600 transition">MongoDB</a>
        <a href="https://groq.com/" target="_blank" class="hover:text-indigo-600 transition">Groq AI</a>
        <a href="https://www.langchain.com/" target="_blank" class="hover:text-indigo-600 transition">LangChain</a>
        <a href="https://brevo.com/" target="_blank" class="hover:text-indigo-600 transition">Brevo</a>
        <a href="https://tailwindcss.com/" target="_blank" class="hover:text-indigo-600 transition">Tailwind CSS</a>
        <a href="https://www.chartjs.org/" target="_blank" class="hover:text-indigo-600 transition">Chart.js</a>
        <a href="https://github.com/eKoopmans/html2pdf.js" target="_blank" class="hover:text-indigo-600 transition">html2pdf.js</a>
        <a href="https://marked.js.org/" target="_blank" class="hover:text-indigo-600 transition">Marked.js</a>
        <a href="https://www.mathjax.org/" target="_blank" class="hover:text-indigo-600 transition">MathJax</a>
    </div>
    <p class="mt-4 text-[10px] text-slate-400">Developed over 60+ hours of research and implementation.</p>
</div>
<!-- =============================================== -->
...
if __name__ == "__main__":
    import uvicorn
    # To run locally with this file: uvicorn app:app --reload
